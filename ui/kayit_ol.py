...
class KayitEkrani(QWidget):
    ...
    def setupVideoBackground(self):
        ...
        if self.shared_cap is not None and self.shared_cap.isOpened():
            ...
            if self.shared_timer is not None:
    ...
    def initUI(self):
        ...
        self.aciklamaLabel.setStyleSheet(
            "color: #bbbbbb; background: transparent; margin-bottom: 15px;"
        )
        ...
        kullanici_label.setStyleSheet(
            "color: white; font-size: 12px; font-weight: bold; background: transparent; border: none;"
        )
        ...
        sifre_tekrar_label.setStyleSheet(
            "color: white; font-size: 12px; font-weight: bold; background: transparent; border: none;"
        )
        ...
        info_label.setStyleSheet(
            "color: #95a5a6; font-size: 11px; background: transparent; margin-top: 5px;"
        )
