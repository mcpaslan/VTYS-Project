...
from PyQt5.QtCore import Qt, QPropertyAnimation, QRect, QEasingCurve, QParallelAnimationGroup, QUrl, QTimer
...
class GirisEkrani(QWidget):
    ...
    def initUI(self):
        ...
        self.kullaniciAdiInput.textChanged.connect(lambda: self._styleLineDefault(self.kullaniciAdiInput))
        ...
        self.sifreInput.textChanged.connect(lambda: self._styleLineDefault(self.sifreInput))
        ...
        self.sifremiUnuttumLabel = QLabel("<a href='#' style='color: #bbbbbb;'>Şifremi unuttum</a>", self)
        ...
        self.kayitOlLabel = QLabel("<a href='kayit' style='color: #e94560;'>Kayıt Ol</a>", self)
    ...
    def kayitEkraninaGec(self):
        ...
        # Paylaşılan video capture ve timer'ı geçir
        self.kayitEkrani = KayitEkrani(video_cap=self.cap, video_timer=self.videoTimer)
    ...
    def kayitEkranindanDon(self):
        if self.kayitEkrani:
            ...
            if hasattr(self, 'videoTimer') and self.videoTimer:
